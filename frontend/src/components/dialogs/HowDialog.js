    ...
    return (
      <dialog className="mdl-dialog" id="how-dialog">
        ...
        <div className="mdl-dialog__content">
          Stacker Squares is built on the <a target="_blank" rel="noreferrer" href="https://www.stacks.co/">Stacks blockchain</a>.
          To mint NFTs, perform the following steps:
          <ol>
            <li>Purchase STX from one of <a target="_blank" rel="noreferrer" href="https://www.stacks.co/explore/get-stx#getstx">these exchanges</a></li>
            <li>
              Install <a target="_blank" rel="noreferrer" href="https://www.hiro.so/wallet">Hiro Wallet</a> &amp;
              transfer the STX you purchased to this wallet
            </li>
